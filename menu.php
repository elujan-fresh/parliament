                ...
                <ul class="nav navbar-nav">
                  <li id="menu-decoration"></li>
                   <li id="index-option"><a id="loadHome" href="#home">Home</a></li>
                      ...
                      <li id="menu-option" class="active"><a href="#menu" id="loadMenu">Menu</a></li>
...
<div id="principal-content" class="principal-frame">
	<div id="pdf">
		<object data="pdf/menu.pdf#toolbar=1&amp;navpanes=0&amp;scrollbar=1&amp;page=1&amp;view=FitH" type="application/pdf" width="100%" height="100%">

		<p>It appears you don't have a PDF plugin for this browser. No biggie... you can <a href="pdf/menu.pdf">click here to download the PDF file.</a></p>
            ...
            <ul>
              ...
              <li>
                  ...
                  <ul id="menu-footer-nav">
                      ...
                      <li id="menu-option-bottom" class="active"><a href="#menu" id="loadMenuBottom">Menu</a></li>
